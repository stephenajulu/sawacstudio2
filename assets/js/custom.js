...
var win = $(window); // viewport dimensions
...
function grid() {
  ...
  for (var i = 0; i < container.length; i++) {
    ...
    if (!margin) margin = 0;
    if (!double_height) double_height = 2; // set margins to the container
    ...
    items.each(function () {
      ...
      /* Add w2 or h2 to the portfolio item for varoius layout sizes */
